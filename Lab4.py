...
while state:
    ...
    def scaling():
        ...
        pygame.draw.polygon(wn, purple, [[x1, y1], [x2, y2], [x3, y3]])
        ...
        pygame.draw.polygon(wn, white, [[s_x1, s_y1], [s_x2, s_y2], [s_x3, s_y3]])
    ...
    def translate():
        ...
        # make final triangle
        pygame.draw.polygon(wn, white, [[t_x1, t_y1], [t_x2, t_y2], [t_x3, t_y3]])
    ...
    def rotation():
        ...
        # final trianfle
        pygame.draw.polygon(wn, white, [[r_x1, r_y1], [r_x2, r_y2], [r_x3, r_y3]])
    ...
    def reflection():
        ...
        pygame.draw.polygon(wn, white, [[rf_x1, rf_y1], [rf_x2, rf_y2], [rf_x3, rf_y3]])
    ...
    def shearing():
        ...
        pygame.draw.polygon(wn, white, [[sh_x1, sh_y1], [sh_x2, sh_y2], [sh_x3, sh_y3]])
